...
function update_user() {
    ...
    let currentUser = fetch(API + document.getElementById("id").value)
        .then((response) => {
    ...
    const new_user = currentUser=== null? {id:"-200"}  : {
    ...
    Object.keys(new_user).forEach((key) => {new_user[key] === ""? delete new_user[key] : null})
